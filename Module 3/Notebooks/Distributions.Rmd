...
d= density; peak of the distribution
...
N = No. of experiment (how many types of exp)
size = size of experiment (how many times in an exp)

* how many rolls in an exp = 20. how many exp = 10k

```{r}
z <- rbinom( n = 10000, size = 20, prob = 1/6 )
y <- rbinom( n = 10, size = 20, prob = 1/6 )
x <- rbinom( n = 5, size = 20, prob = 1/6 )
a <- rbinom( n = 20000, size = 20, prob = 1/6 )
# z
#Let's also plot this and see how it looks
hist(z, breaks =25, col = 'steelblue')
hist(y, breaks =25, col = 'steelblue')
hist(x, breaks =25, col = 'steelblue')
hist(a, breaks =25, col = 'steelblue')
```
