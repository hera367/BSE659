...
scatterplot(dan.grump ~ baby.sleep, data = parenthood)

scatterplot(dan.grump ~ baby.sleep, data = parenthood, regLine = FALSE)
...
scatterplot(dan.sleep ~ baby.sleep, data = parenthood, regLine = FALSE, smooth = FALSE)
```
